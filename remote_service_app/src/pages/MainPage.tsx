...
const MainPage: FC = () => {
    ...
    return (
        <BasePage>
            <div className='container d-flex flex-column justify-content-center mt-5 border shadow shadow-bg p-3 w-100 bg-white'>
                ...
                <div className='d-flex flex-column mt-4'>
                    ...
                    <p>Агент удаленной поддержки и обслуживаемое им рабочее место могут находиться в абсолютно разных местах, на расстоянии многих километров. Чтобы переустановить систему, очистить компьютер от вирусов, настроить работу периферийного оборудования специалисту нет необходимости тратить время на дорогу. Многие задачи вполне могут быть решены удаленно, в режиме онлайн.</p>
                </div>
            </div>
        </BasePage>
    )
